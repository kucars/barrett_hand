"""autogenerated by genpy from owd_msgs/ReplaceTrajectoryRequest.msg. Do not edit."""
import sys
...
class ReplaceTrajectoryRequest(genpy.Message):
  _md5sum = "298c801f215034875ff1b387cdf8597c"
  _type = "owd_msgs/ReplaceTrajectoryRequest"
...
"""
  __slots__ = ['traj','id']
  _slot_types = ['owd_msgs/JointTraj','uint32']
...
"""autogenerated by genpy from owd_msgs/ReplaceTrajectoryResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ReplaceTrajectoryResponse(genpy.Message):
  ...
  _type = "owd_msgs/ReplaceTrajectoryResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class ReplaceTrajectory(object):
  _type          = 'owd_msgs/ReplaceTrajectory'
  _md5sum = 'cc1272a1b0295224dc0b1b55f99d0d36'
